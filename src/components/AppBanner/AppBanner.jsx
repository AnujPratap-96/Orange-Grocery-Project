        ...
        >
          ...
          <div className=" space-y-6 max-w-xl mx-auto">
            ...
            <p
              data-aos="fade-up"
              data-aos-delay="300"
              className="text-center sm:px-20 font-normal"
            >
              Quick, easy, safe, reliable, convenient, secure, user-friendly,
              fast, seamless, accessible, trusted, efficient, hassle-free.{" "}
            </p>
            {/* image link  */}
            <div 
            data-aos="fade-up"
